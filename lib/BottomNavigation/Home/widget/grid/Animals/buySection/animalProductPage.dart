...
class AnimalProductView extends StatefulWidget {
  // const ProductView({Key? key}) : super(key: key);
  AnimalProductView({super.key, required this.data});
  BuyAnimalHomeDataModel data;

  @override
  State<AnimalProductView> createState() => _AnimalProductViewState();
}

class _AnimalProductViewState extends State<AnimalProductView> {
