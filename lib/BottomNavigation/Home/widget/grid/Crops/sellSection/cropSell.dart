...
class _SellSectionState extends State<SellSection> {
  ...
  Future<bool> _uploadData(List<String> imageUrls) async {
    try {
      ...
      DocumentReference cropDocumentReference = await firestore
      ...
      String cropDocumentId = cropDocumentReference.id;
      print(cropDocumentId);

      // Add a new document with a generated ID
      await firestore.collection('Crops').doc(cropDocumentId).set({
        'userId': firebaseUser,
        'ownerName': ownerName,
        'cropName': cropName,
        'totalQuintal': totalQuintal,
    ...
    try {
      for (int i = 0; i < pickedImages!.length; i++) {
        ...
        firabase_storage.Reference ref = firabase_storage
            ...
            .child('Crops')
            .child(cropName!)
            .child('/${cropName}_$i.jpg'); // Use a unique name for each image
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          style: TextStyle(color: Colors.black),
                          decoration: textInputDecoration.copyWith(
                            hintText: "Enter total Quintal",
                          ),
                          onChanged: (value) {
                            totalQuintal = double.parse(value);
                            //Do something with the user input.
                          },
                        ),
                      ),
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration: textInputDecoration.copyWith(
                            ...
                            hintText: "Price Per Quintal",
                          ),
                          onChanged: (value) {
                            pricePerQue = double.parse(value);
                            // Handle onChanged
                          },
                        ),
                      ),
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return 'Please enter the Description of Your Crop.';
                      }
                      return null;
                      // Validation logic
                    },
