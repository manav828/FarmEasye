...
class FertilizerProductView extends StatefulWidget {
  // const ProductView({Key? key}) : super(key: key);
  FertilizerProductView({super.key, required this.data});
  BuyFertilizerModel data;

  @override
  State<FertilizerProductView> createState() => _FertilizerProductViewState();
}

class _FertilizerProductViewState extends State<FertilizerProductView> {
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                "/${widget.data.weightInKG?.toInt()}KG",
                                style: GoogleFonts.roboto(
                                    fontSize: 20,
                                    fontWeight: FontWeight.w400,
                                    color: Colors.grey),
