...
class FertilizerSellSection extends StatefulWidget {
  const FertilizerSellSection({Key? key}) : super(key: key);

  @override
  State<FertilizerSellSection> createState() => _FertilizerSellSectionState();
}

class _FertilizerSellSectionState extends State<FertilizerSellSection> {
  final _formKey = GlobalKey<FormState>(); // Add form key

  List<String>? pickedImages = [];
  String? FertilizerName;
  String? FertilizerCompany;
  String? ownerName;
  String? shopName;
  double? Price;
  double? weightInKG;
  ...
  Future<bool> _uploadData(List<String> imageUrls) async {
    try {
      ...
      DocumentReference fertilierDocumentReference = await firestore
        ...
        'FertilizerCompany': FertilizerCompany,
        'Price': Price,
      ...
      String fertilierDocumentId = fertilierDocumentReference.id;

      await firestore.collection('Fertilier').doc(fertilierDocumentId).set({
    ...
    try {
      for (int i = 0; i < pickedImages!.length; i++) {
        ...
        firabase_storage.Reference ref = firabase_storage
            ...
            .child('Users')
            .child('Fertilizer')
            .child(FertilizerName!)
            .child(
                '/${FertilizerName}_$i.jpg'); // Use a unique name for each image
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'Please enter the FertilizerName.';
                            }
                            return null;
                          },
                          textAlignVertical: TextAlignVertical.bottom,
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'Please enter the FertilizerCompany.';
                            }
                            return null;
                          },
                          textAlignVertical: TextAlignVertical.bottom,
                          ...
                          decoration: textInputDecoration.copyWith(
                            ...
                            //   color: Primery_color,
                            // ),
                            hintText: "Enter FertilizerCompany",
                          ),
                          onChanged: (value) {
                            FertilizerCompany = value;
                            // Handle onChanged
                          },
                        ),
                      ),
